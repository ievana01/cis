    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0A3D62">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Accessories Store</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePenjualan" class="collapse" aria-labelledby="headingPenjualan"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href={{ route('sales.index') }}>Sales Orders</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSediaan" class="collapse" aria-labelledby="headingSediaan"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="report-stock">Stock Product Location</a>

                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Configuration</h6>
                        <a class="collapse-item" href="inventory-configuration">Inventory Configuration</a>
                    </div>
                </div>
            </li>
